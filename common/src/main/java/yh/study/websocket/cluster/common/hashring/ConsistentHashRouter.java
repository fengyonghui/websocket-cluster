package yh.study.websocket.cluster.common.hashring;
...
public class ConsistentHashRouter<T extends Node> {
    ...
    private final HashAlgorithm hashAlgorithm=new MD5Hash();
    ...
    public ConsistentHashRouter(Map ring){
        this.ring.putAll(ring);
    }
     ...
     * @return 虚拟节点数量
     */
    public Integer getVirtualNodeCountOf(T physicalNode) {
